...
if (isset($_POST['id_rel'])){
    ...
    $query = "SELECT cpp.id_aval, r.caminho, avop.descricao as 'nota_prof', e.descricao as 'comment_aluno', av.descricao as 'comment_prof', avopcpp.descricao as 'nota_cpp', cpp.descricao as 'comment_cpp'
    ...
    if($result)
    {
            ...
            echo json_encode(array("id_aval"=> $row['id_aval'] ,"caminho"=> $row['caminho'],"comment_aluno" => $row['comment_aluno'],"nota_prof" => $row['nota_prof'], "comment_prof" => $row['comment_prof'], "nota_cpp" => $row['nota_cpp'], "comment_cpp" => $row['comment_cpp'] ));
    }       
